...
public class ObjectsManager_old : MonoBehaviour
{
    public static ObjectsManager_old instance;
    ...
    private PlayerController__old _player;
    ...
    private void Start()
    {
        _player = PlayerController__old.instance;
        _uiManager = UIManager.instance;
        _gameManager = GameManager_old.instance;
        
        bonusBoxStartPos = uiItemBoxes[3].transform.position;

        PlayerAttacks_old.instance.dexterity = gameVariables.baseDexterity;
        _player.maxSpeed = gameVariables.baseSpeed;
        PlayerAttacks_old.instance.attackStat = gameVariables.baseAttack;
        AssignObjectInfos();
    }
    ...
    public void OnPlayerHit(int sourceDamage)
    {
        ...
        if (sacredCross)
        {
            PlayerController__old.instance.invincibleCounter = gameVariables.sacredCrossLength;
        }
