...
public class MenuManager_old : MonoBehaviour
{
    ...
    private CheatManager_old _cheatManagerOld;
    ...
    private void Start()
    {
        ...
        _cheatManagerOld = CheatManager_old.instance;
    ...
    public IEnumerator StartLevel()
    {
        ...
        player.GetComponent<PlayerController__old>().enabled = true;
        player.GetComponent<PlayerAttacks_old>().enabled = true;
        Time.timeScale = 1;
        loadingUI.SetActive(false);
    ...
    public void RestartLevel()
    {
        ...
        GameManager_old.instance.isDead = false;
        SwitchState(GameState.Loading);
	    Time.timeScale = 1;
        GameManager_old.instance.maxHealth = 10;
        GameManager_old.instance.health = 10;
        GameManager_old.instance.money = 0;
        GameScore_old.instance.tempScore = 0;
        GameManager_old.instance.currentLevel = 0; ;
        LevelManager.instance.currentLevel = 0;

        for (int i = 0; i < ObjectsManager_old.instance.itemObjectsInventory.Count; i++)
        {
            ObjectsManager_old.instance.itemObjectsInventory[i] = 999;
        }
        ...
        StartCoroutine(MenuManager_old.instance.StartLevel());
        SceneManager.LoadScene("MainScene");
    ...
    public IEnumerator EndGame()
    {
        ...
        MenuManager_old.instance.winScreen.CrossFade(Animator.StringToHash("Open"), 0);
    ...
    {
        GameScore_old.instance.leaderboardMenu.SetActive(false);
    ...
    private void ConfirmButton(InputAction.CallbackContext context)
    {
        switch (gameState)
        {
            ...
            case GameState.Console : 
                //use console
                _cheatManagerOld.CloseCommandLine();
                break;
    ...
    private void UpButton(InputAction.CallbackContext context)
    {
        ...
        {
            case GameState.Console : 
                _cheatManagerOld.InputLastCommand();
                break;
            case GameState.Inventory : 
                //moves inventory box
                buttonPos++;
    ...
    private void CommandLineShortcut(InputAction.CallbackContext context)
    {
        ...
        { 
            case GameState.Play : 
                _cheatManagerOld.OpenCommandLine();
